    ...
    <DashboardLayout>
      <div className="space-y-6">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
          <div>
            <h1 className="text-2xl sm:text-3xl font-heading font-bold text-gray-900">Inventory</h1>
            <p className="text-sm sm:text-base text-gray-500 mt-1">Manage your products and stock levels</p>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-500 text-xs sm:text-sm font-medium">Total Stock Value</p>
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">₱{formatCurrency(totalStockValue)}</p>
              </div>
              <div className="bg-green-50 p-2 sm:p-3 rounded-lg">
                <svg className="text-green-500" width="20" height="20" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-100">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl sm:text-3xl font-bold text-gray-900 mt-1">{lowStockCount}</p>
              </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <button
                ...
                className="flex items-center gap-1 sm:gap-2 bg-primary-500 hover:bg-primary-600 text-white px-3 sm:px-4 py-2 text-sm rounded-lg transition-colors shadow-sm cursor-pointer"
              >
                <Plus size={18} />
                  ...
                  {filteredProducts.map((product) => {
                    ...
                    return (
                      <tr key={product.$id} className="hover:bg-gray-50 transition-colors">
                        ...
                        <td className="px-6 py-4 text-right text-gray-900" data-label="Cost">₱{formatCurrency(product.costPrice)}</td>
                        <td className="px-6 py-4 text-right text-gray-900" data-label="Price">₱{formatCurrency(product.sellingPrice)}</td>
                        <td className="px-6 py-4 text-right" data-label="Qty">
                          <span className={`font-semibold ${isLowStock ? 'text-orange-500' : 'text-gray-900'}`}>
                            {product.quantity}
                          </span>
                        </td>
                        <td className="px-6 py-4 text-right" data-label="Profit/Item">
                          <span className={`font-semibold ${profitPerItem > 0 ? 'text-green-600' : 'text-red-600'}`}>
                            ₱{formatCurrency(profitPerItem)}
                          </span>
                        </td>
                        <td className="px-6 py-4 text-right font-medium text-gray-900" data-label="Stock Value">₱{formatCurrency(stockValue)}</td>
